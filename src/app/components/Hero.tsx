      ...
      >
        <div className="flex flex-row items-center py-[6px] px-4 rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white">20%</span> Lorem ipsum{" "}
            <span className="text-white">1 lorem</span> ipsum
          </p>
        </div>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          quasi obcaecati sed atque saepe iure dolor natus reprehenderit
          accusamus voluptatem sit libero dicta quidem, accusantium, quod
          officiis rerum placeat doloribus!
        </p>
      </div>
