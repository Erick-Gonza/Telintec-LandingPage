    ...
    <main className="w-full flex-grow xl:flex xl:flex-col items-center">
      ...
      >
        ...
        <p className="font-poppins font-normal xs:text-[20px] text-[15px] xs:leading-[26px] leading-[21px] text-text-off dark:text-text-dark-off">
          ...
          objetivo principal es ayudar a nuestros clientes a mejorar la calidad,
          seguridad y disponibilidad de su información, a través de la
          consultoría especializada, ingeniería e implementación de sistemas de
          comunicación y soluciones inteligentes de vídeo y control deacceso.
          Todo esto es posible gracias al apoyo de un gran equipo de trabajo
          cuya motivación es la colaboración y el servicio al cliente.
        </p>
        ...
        <p className="font-poppins font-normal xs:text-[20px] text-[15px] xs:leading-[26px] leading-[21px] text-text-off dark:text-text-dark-off">
          ...
          respaldados ensus áreas de desarrollo tecnológico. Que nuestro capital
          humano, logre desarrollar su objetivos profesionales para su beneficio
        ...
        <p className="font-poppins font-normal xs:text-[20px] text-[15px] xs:leading-[26px] leading-[21px] text-text-off dark:text-text-dark-off">
          Consolidarnos como los socios estratégicos de las empresas líderes en
          elmercado mundial a través de la optimización e innovación en el campo
